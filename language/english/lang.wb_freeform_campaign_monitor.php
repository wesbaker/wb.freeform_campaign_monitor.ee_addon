<?php
/**
* English language file for WB Freeform Campaign Monitor
* 
...
"api_key" => "Campaign Monitor API Key <small style='display:block; margin-top:6px; font-weight:normal'>You can find this under Account Settings in the API Key section.</small>",

"list_id" => "Subscriber List ID <small style='display:block; margin-top:6px; font-weight:normal'>You can find this by clicking on the list and then clicking on edit list name/type.</small>",

'switch_field' => 'Switch Input Field Name <small style="display:block; margin-top:6px; font-weight:normal">This is the value that will determine whether to add the email address to the subscriber list.</small>', 

'switch_field_value' => 'Switch Input Field Value', 

'name_field' => 'Name Input Field Name', 
